...
const COLORES = ['#0A2F7E', '#0050B8', '#575200', '#A32B1A', '#006048', '#EC4899', '#2B6DD4', '#F97316']
        ...
        <div className="reportes-secciones" ref={chartsRef}>
          ...
          {tabActivo === 0 && (<>
            ...
            <div className="chart-grid">
              ...
              <div className="chart-card">
                ...
                <ResponsiveContainer width="100%" height={300}>
                  <PieChart><Pie data={data.tiposLavado} cx="50%" cy="50%" innerRadius={60} outerRadius={100} dataKey="value" label={renderLabel}><Cell fill="#0A2F7E" /><Cell fill="#0050B8" /></Pie><Tooltip content={<PieTooltip />} /><Legend /></PieChart>
                </ResponsiveContainer>
              </div>
            </div>
          ...
          {tabActivo === 2 && (<>
            ...
            <div className="chart-card chart-full">
              ...
              <ResponsiveContainer width="100%" height={300}>
                <LineChart data={data.tend6}><CartesianGrid strokeDasharray="3 3" stroke={CHART_THEME.grid} /><XAxis dataKey="mes" stroke={CHART_THEME.axis} fontSize={12} /><YAxis stroke={CHART_THEME.axis} fontSize={12} tickFormatter={fmtCorto} /><Tooltip content={<ChartTooltip formatter={fmt} />} /><Line type="monotone" dataKey="ticket" stroke="#006048" strokeWidth={2} dot={{ fill: '#006048', r: 4 }} name="Ticket promedio" /></LineChart>
              </ResponsiveContainer>
            </div>
              ...
              {data.clientesDiarios.some(d => d.nuevos > 0) ? (
                <ResponsiveContainer width="100%" height={300}>
                  <BarChart data={data.clientesDiarios}>
                    ...
                    <Bar dataKey="nuevos" name="Nuevos" fill="#0A2F7E" radius={[4, 4, 0, 0]} />
                  </BarChart>
                </ResponsiveContainer>
